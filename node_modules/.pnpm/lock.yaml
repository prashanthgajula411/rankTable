...
dependencies:
  '@craco/craco': 6.4.3_react-scripts@5.0.0
  '@testing-library/jest-dom': 5.16.1
  ...
  react-loader-spinner: 4.0.0_react-dom@17.0.2+react@17.0.2
...
devDependencies:
  ...
  babel-plugin-styled-components: 2.0.2_styled-components@5.3.3
  eslint: 8.5.0
  eslint-config-airbnb: 18.2.1_eslint@8.5.0
  eslint-config-prettier: 8.1.0_eslint@8.5.0
  eslint-plugin-prettier: 3.3.1_74eefd79d886b5792725ef0020dcfdcd
  lint-staged: 10.5.4
  prettier: 2.5.1
...
packages:
  ...
  /@csstools/postcss-unset-value/1.0.0_postcss@8.4.13:
    resolution: {integrity: sha512-T5ZyNSw9G0x0UDFiXV40a7VjKw2b+l4G+S0sctKqxhx8cg9QtMUAGwJBVU9mHPDPoZEmwm0tEoukjl4zb9MU7Q==}
    engines: {node: ^12 || ^14 || >=16}
    peerDependencies:
      postcss: ^8.3
    dependencies:
